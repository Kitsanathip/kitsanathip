        ...
        <div class="form-container">
            ...
            <form action="f.php" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="text" class="form-control" id="fullname" placeholder="ระบุชื่อและนามสกุล" required>
                        </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="skills" rows="3" placeholder="เช่น ทักษะภาษาอังกฤษ, คอมพิวเตอร์, การขับรถ หรือใบรับรองต่างๆ"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="experience" rows="4" placeholder="ระบุชื่อบริษัท ตำแหน่ง และระยะเวลาที่เคยทำ (หากไม่มีให้ระบุว่า 'ไม่มีประสบการณ์')"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-5">
                    ...
                    <button class="btn btn-primary px-5" type="submit">ส่งใบสมัคร</button>
                </div>
